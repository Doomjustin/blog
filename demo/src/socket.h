 ...
 * @tparam Context Execution context type associated with the socket.
 */
...
public:
    ...
    /**
     * @brief Read and clear pending socket error state after async/poll events.
     *
     ...
     */
    explicit BaseSocket(Context& context)
      : context_{ &context }
    {}
     ...
     * close and makes ownership handoff explicit in async pipelines.
     *
