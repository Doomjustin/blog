#ifndef BLOG_WRITE_SEQUENCE_WAITER_H
#define BLOG_WRITE_SEQUENCE_WAITER_H
 ...
 *
 * @tparam Context Execution context type that can provide SQEs.
 * @tparam Buffer  Buffer sequence type satisfying `sequence_buffer`.
 */
template<typename Context, sequence_buffer Buffer>
...
#endif // BLOG_WRITE_SEQUENCE_WAITER_H